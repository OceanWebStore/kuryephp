                      ...
                      <div class="card border-0 shadow-lg">
                          <div class="card-body p-5">
                              <div class="text-center">
                                  ...
                                  <h4 class="fw-bold text-dark mb-2">Hoşgeldiniz !</h3>
                                  <p class="text-muted">Lütfen Hesabınıza Giriş Yapınız.</p>
                              </div>
                              <form action="###" class="mt-4">
                                  ...
                                  <div class="mb-3">
                                      <div class="d-flex justify-content-between align-items-center">
                                          ...
                                          <a href="sifremi-unuttum.html" class="text-decoration-none small text-muted">Şifrenizi mi Unuttunuz ?</a>
                                      </div>
                                  ...
                                  <div class="d-grid">
                                      <button class="btn btn-dark btn-lg fw-medium" type="submit">Giriş Yap</button>
                                  </div>
                              </form>
                          </div>
                      </div>
                      <p class="text-center mt-4 text-white text-opacity-50">Hesabınız Yok mu ?
                          <a href="kayit-ol.html" class="text-decoration-none text-white fw-bold">Üye Ol</a>
                      </p>
                  </div>
              </div>
          </div>
